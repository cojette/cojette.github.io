...
하지만 이럴 때 ‘데이터는 필요한 사람이 볼 수 있도록 최대한 노력하되 급할 때나 어려울 때는 할 줄 아는 사의 힘을 조금 빌리자’ 가 아닌 ‘우리는 우리의 일을 할테니 데이터를 뽑아주는 일을 맡길 사람을 찾자’라는 생각은 그 당사자에게도, 회사에게도 장기적으로 그다지 좋은 일은 아닐 것이라고 생각한다.
