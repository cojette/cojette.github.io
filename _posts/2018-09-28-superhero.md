...
예전에는 ‘슈퍼히어로물’이라고 하면 ‘슈퍼맨’으로 대표되는 캐릭터로 어느 정도의 인지도는 있으나  허무맹랑하며 익숙하지 않은 거대한 스케일에 다소 이질적이고 유치한 장르였으나, 최근에는 DC와 마블 코믹스 기반의 영화들로 굉장히 친숙한 장르가 되었다. 다만 친숙해지는 과정 속에서 ‘슈퍼히어로물’ 이라고 하면 여전히 장르 이름(?)도 영어에서 유래한 것처럼, 외국 중심의, 그나마도 현실을 반영한 가상 공간에서, 비현실적인 능력을 가진, ‘**맨’, ‘**우먼’ 등의 이름이 붙는 히어로와 악당의 싸움이 주를 이루는 일종의 이세계물로 자리잡아 버린 감도 없지 않아 있다.
