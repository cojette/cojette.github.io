...
진행 전까지는 해당 사실을 절대 타인에게 누설하지 않을 것이고요(!). 저에게 여러 방면으로 연락을 주시면 되겠습니다. 이력서를 주시면 아주 좋겠지만(!) 궁금한 것들이 더 많을텐데, 따로 질문을 주시거나 이야기를 할 수도 있겠지요. 개인 메시지, 메일(cojette@gmail.com) 등으로 연락 주시면 성심성의껏 좀 더 자세히 이야기 나눌 수 있도록 하겠습니다.
